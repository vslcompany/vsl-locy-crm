...
import { CreateBusinessModal, UpdateBusinessModal } from "@/modals";
import {
    TAuthContextProps,
...
type TColumn = TTableColumn<TBusinessDto>;
...
const BusinessTable = () => {
    ...
    const openUpdateModal = useCallback((data: TUpdateBusinessRequest) => {
                        ...
                        <Tooltip arrow placement="left" title="Chỉnh sửa">
                            <IconButton
                                ...
                                onClick={() => {
                                    ...
                                    const payload: TUpdateBusinessRequest = {
                                        id: data.id,
                                        code: data.code,
                                        nameVI: data.nameVI,
                                        nameEN: data.nameEN,
                    ...
                    <>
                        <Tooltip arrow placement="right" title="Yêu cầu xoá">
                            <IconButton
                                color="error"
                                onClick={() => {
                                    const { id } = row.original as TBusinessDto;
    ...
    return (
        <>
            ...
            {(user?.permission.includes("1048576") ||
                user?.permission.includes("6000")) && (
                <UpdateBusinessModal
                    title="Chỉnh sửa loại doanh nghiệp"
            ...
            {(user?.permission.includes("1048576") ||
                ...
                <Modal
                    ...
                    description="bạn muốn thực hiện xoá loại doanh nghiệp này?"
