...
import { CreateCityModal, UpdateCityModal } from "@/modals";
import {
    TAuthContextProps,
    TCreateCityRequest,
    TCityDto,
...
type TColumn = TTableColumn<TCityDto>;
...
const CityTable = () => {
    ...
    const openUpdateModal = useCallback((data: TUpdateCityRequest) => {
                        ...
                        <Tooltip arrow placement="left" title="Chỉnh sửa">
                            <IconButton
                                ...
                                onClick={() => {
                                    ...
                                    const payload: TUpdateCityRequest = {
                                        id: data.id,
                                        code: data.code,
                                        nameVI: data.nameVI,
                                        nameEN: data.nameEN,
                    ...
                    <>
                        <Tooltip arrow placement="right" title="Yêu cầu xoá">
                            <IconButton
                                color="error"
                                onClick={() => {
                                    const { id } = row.original as TCityDto;
        ...
        <>
            ...
            {(user?.permission.includes("1048576") ||
                ...
                <Modal
                    ...
                    title="Xoá thành phố"
                    description="bạn muốn thực hiện xoá thành phố này?"
